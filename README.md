...
* Smooth hover animation with zoom and shadow effects

* Lightbox view for enlarged images

* Close button (×) and background click to exit lightbox
...
* JavaScript – Lightbox functionality and event handling
